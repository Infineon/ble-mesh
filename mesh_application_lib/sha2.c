...
// - sha256.c and hmac_sha256.c were combined into this file
// - Additionally the original includes of sha256.h and hmac_sha256.h are commented
//   and replaced with include of sha2.h
...
size_t hmac_sha256(const void* key,
  ...
  sz = (outlen == 0 || outlen > SHA256_HASH_SIZE) ? SHA256_HASH_SIZE : outlen;
  memcpy(out, ohash, sz);
  return sz;
}
